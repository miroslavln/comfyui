...
function provisioning_start() {
    ...
    cp "${WORKSPACE}/storage/stable_diffusion/models/clip_vision/model.safetensors" "${WORKSPACE}/storage/stable_diffusion/models/clip_vision/CLIP-ViT-H-14-laion2B-s32B-b79K.safetensors"
